...
const NAV = [
  ...
  { to: '/pipeline', label: 'Воронка', icon: 'ti-chart-dots', section: 'Продажи', adminOnly: true },
  ...
  return (
    <div className="app">
      ...
      <aside className={`sidebar${sidebarOpen ? ' open' : ''}`}>
        <div style={{ padding: '14px 16px', background: '#ffffff', borderBottom: '1px solid rgba(255,255,255,.1)' }}>
          <img src="/logo.png" alt="Deshthaus Architects" style={{ width: '100%', maxWidth: 170, display: 'block' }} />
        </div>
        <nav className="nav">
          {visibleNav.map((item) => (
            <div key={item.to}>
