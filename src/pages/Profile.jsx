...
export default function Profile() {
  ...
  async function changePassword(e) {
    ...
    if (next.length < 4) { setErr('Минимум 4 символа'); return }
    setLoading(true)
    try {
      ...
      <div className="panel">
        ...
        <div style={{ padding: 18 }}>
          ...
          <form onSubmit={changePassword}>
            <div className="fg"><label>Текущий пароль</label><input type="password" value={cur} onChange={e => setCur(e.target.value)} placeholder="••••••••" required /></div>
            <div className="fg"><label>Новый пароль</label><input type="password" value={next} onChange={e => setNext(e.target.value)} placeholder="Минимум 4 символа" required /></div>
            <div className="fg"><label>Повторите новый пароль</label><input type="password" value={confirm} onChange={e => setConfirm(e.target.value)} placeholder="••••••••" required /></div>
